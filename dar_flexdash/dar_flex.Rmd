...
-   The results of the calculations will populate in the `value boxes` above. If the `AR Change Needed` box's figure is enclosed in parentheses, it is showing the dollar amount that must be *removed* from the AR balance for Days in AR to fall below your target DAR.
-   The graph to the left will display the Gross Charges and Ending AR balance, on the x- and y-axis, respectively. If the point labelled "Actual DAR" is *red, triangular* and *above* and *to the left* of the dashed line, your Days in AR is *above* the target DAR you entered.
...
# color2 <- reactive({
#     dplyr::case_when(dar2() > input$dart ~ "#D50A0A", TRUE ~ "#013369")
#     })
#     
# shape2 <- reactive({
#     dplyr::case_when(dar2() > input$dart ~ 17, TRUE ~ 19)
#     })
...
output$scatter1 <-renderPlot({
    ...
    ggplot(group=1) +
        ...
        #     color = color2(),
        #     fill = color2(),
        #     label = paste0("Target DAR: ", round(dar2(), digits = 2))),
        #     size = 5,
        #     fontface = "bold", color = "white",
        #     force = 0.3,
        #     force_pull = 0.2,
        ...
        #     ) +
            ...
            labs(
              title = "Days in AR Key Indicator: Total Gross Charges & Ending AR Balance",
